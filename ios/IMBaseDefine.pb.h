...
typedef NS_ENUM(SInt32, MessageCmdID) {
  ...
  MessageCmdIDCidMsgDataConnToClient = 783,
};
...
typedef NS_ENUM(SInt32, OtherCmdID) {
  ...
  OtherCmdIDCidOtherUidconnmap = 1845,
  OtherCmdIDCidOtherReportConnectionServerName = 1846,
  OtherCmdIDCidOtherAddSendList = 1847,
  OtherCmdIDCidOtherDelSendList = 1848,
};
...
typedef NS_ENUM(SInt32, FileType) {
