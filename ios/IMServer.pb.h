...
@class IMConnectionServerName;
@class IMConnectionServerNameBuilder;
...
#define IMValidateReq_client_handle @"clientHandle"
...
@property (readonly) UInt32 clientHandle;
...
#define IMValidateRsp_client_handle @"clientHandle"
...
#define IMMsgServInfo_client_handle @"clientHandle"
...
#define IMConnectionServerName_server_name @"serverName"
@interface IMConnectionServerName : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
...
@interface IMConnectionServerNameBuilder : PBGeneratedMessageBuilder {
@private
  IMConnectionServerName* resultImconnectionServerName;
}
