...
#define IMMsgData_to_server_name @"toServerName"
@interface IMMsgData : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasToServerName_:1;
  BOOL hasMsgData_:1;
...
@property (readonly, strong) NSString* toServerName;
...
#define IMClientTimeReq_user_id @"userId"
...
#define IMClientTimeRsp_user_id @"userId"
