...
- (BOOL) hasClientHandle {
  return !!hasClientHandle_;
}
- (void) setHasClientHandle:(BOOL) _value_ {
  hasClientHandle_ = !!_value_;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  if (self.hasClientHandle) {
    [output writeUInt32:1 value:self.clientHandle];
  }
  if (self.hasUserName) {
  ...
  if (self.hasClientType) {
    [output writeEnum:5 value:self.clientType];
  }
...
- (SInt32) serializedSize {
  ...
  size_ = 0;
  if (self.hasClientHandle) {
    size_ += computeUInt32Size(1, self.clientHandle);
  }
  if (self.hasUserName) {
  ...
  if (self.hasClientType) {
    size_ += computeEnumSize(5, self.clientType);
  }
  if (self.hasClientVersion) {
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasClientHandle) {
    [output appendFormat:@"%@%@: %@\n", indent, @"clientHandle", [NSNumber numberWithInteger:self.clientHandle]];
  }
  if (self.hasUserName) {
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  if (self.hasClientHandle) {
    [dictionary setObject: [NSNumber numberWithInteger:self.clientHandle] forKey: @"clientHandle"];
  }
  if (self.hasUserName) {
...
- (BOOL) isEqual:(id)other {
  ...
  return
      self.hasClientHandle == otherMessage.hasClientHandle &&
      (!self.hasClientHandle || self.clientHandle == otherMessage.clientHandle) &&
...
- (NSUInteger) hash {
  ...
  if (self.hasClientHandle) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInteger:self.clientHandle] hash];
  }
  if (self.hasUserName) {
...
- (IMMsgServReqBuilder*) mergeFrom:(IMMsgServReq*) other {
  ...
  if (other.hasClientHandle) {
    [self setClientHandle:other.clientHandle];
  }
...
- (IMMsgServReqBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 8: {
        [self setClientHandle:[input readUInt32]];
        break;
      }
      case 18: {
...
- (BOOL) hasClientHandle {
  return resultImmsgServReq.hasClientHandle;
}
- (UInt32) clientHandle {
  return resultImmsgServReq.clientHandle;
}
- (IMMsgServReqBuilder*) setClientHandle:(UInt32) value {
  resultImmsgServReq.hasClientHandle = YES;
  resultImmsgServReq.clientHandle = value;
  return self;
}
- (IMMsgServReqBuilder*) clearClientHandle {
  resultImmsgServReq.hasClientHandle = NO;
  resultImmsgServReq.clientHandle = 0;
  return self;
}
- (BOOL) hasUserName {
  return resultImmsgServReq.hasUserName;
}
- (NSString*) userName {
  return resultImmsgServReq.userName;
}
- (IMMsgServReqBuilder*) setUserName:(NSString*) value {
  resultImmsgServReq.hasUserName = YES;
  resultImmsgServReq.userName = value;
  return self;
}
- (IMMsgServReqBuilder*) clearUserName {
  resultImmsgServReq.hasUserName = NO;
  resultImmsgServReq.userName = @"";
  return self;
}
- (BOOL) hasPassword {
  return resultImmsgServReq.hasPassword;
}
- (NSString*) password {
  return resultImmsgServReq.password;
}
- (IMMsgServReqBuilder*) setPassword:(NSString*) value {
  resultImmsgServReq.hasPassword = YES;
  resultImmsgServReq.password = value;
  return self;
}
- (IMMsgServReqBuilder*) clearPassword {
  resultImmsgServReq.hasPassword = NO;
  resultImmsgServReq.password = @"";
  return self;
}
- (BOOL) hasOnlineStatus {
  return resultImmsgServReq.hasOnlineStatus;
}
- (UserStatType) onlineStatus {
  return resultImmsgServReq.onlineStatus;
}
- (IMMsgServReqBuilder*) setOnlineStatus:(UserStatType) value {
  resultImmsgServReq.hasOnlineStatus = YES;
  resultImmsgServReq.onlineStatus = value;
  return self;
}
- (IMMsgServReqBuilder*) clearOnlineStatus {
  resultImmsgServReq.hasOnlineStatus = NO;
  resultImmsgServReq.onlineStatus = UserStatTypeUserStatusOnline;
  return self;
}
- (BOOL) hasClientType {
  return resultImmsgServReq.hasClientType;
}
- (ClientType) clientType {
  return resultImmsgServReq.clientType;
}
- (IMMsgServReqBuilder*) setClientType:(ClientType) value {
  resultImmsgServReq.hasClientType = YES;
  resultImmsgServReq.clientType = value;
  return self;
}
- (IMMsgServReqBuilder*) clearClientType {
  resultImmsgServReq.hasClientType = NO;
  resultImmsgServReq.clientType = ClientTypeClientTypeWindows;
  return self;
}
- (BOOL) hasClientVersion {
  return resultImmsgServReq.hasClientVersion;
}
- (NSString*) clientVersion {
  return resultImmsgServReq.clientVersion;
}
- (IMMsgServReqBuilder*) setClientVersion:(NSString*) value {
  resultImmsgServReq.hasClientVersion = YES;
  resultImmsgServReq.clientVersion = value;
  return self;
}
- (IMMsgServReqBuilder*) clearClientVersion {
  resultImmsgServReq.hasClientVersion = NO;
  resultImmsgServReq.clientVersion = @"";
  return self;
}
@end
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasClientHandle) {
    [output writeUInt32:5 value:self.clientHandle];
  }
  if (self.hasUserName) {
    [output writeString:6 value:self.userName];
  }
  if (self.hasPassword) {
    [output writeString:7 value:self.password];
  }
  if (self.hasOnlineStatus) {
    [output writeEnum:8 value:self.onlineStatus];
  }
  if (self.hasClientType) {
    [output writeEnum:9 value:self.clientType];
  }
  if (self.hasClientVersion) {
    [output writeString:10 value:self.clientVersion];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  if (self.hasClientHandle) {
    size_ += computeUInt32Size(5, self.clientHandle);
  }
  if (self.hasUserName) {
    size_ += computeStringSize(6, self.userName);
  }
  if (self.hasPassword) {
    size_ += computeStringSize(7, self.password);
  }
  if (self.hasOnlineStatus) {
    size_ += computeEnumSize(8, self.onlineStatus);
  }
  if (self.hasClientType) {
    size_ += computeEnumSize(9, self.clientType);
  }
  if (self.hasClientVersion) {
    size_ += computeStringSize(10, self.clientVersion);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (BOOL) hasClientHandle {
  return resultImmsgServRsp.hasClientHandle;
}
- (UInt32) clientHandle {
  return resultImmsgServRsp.clientHandle;
}
- (IMMsgServRspBuilder*) setClientHandle:(UInt32) value {
  resultImmsgServRsp.hasClientHandle = YES;
  resultImmsgServRsp.clientHandle = value;
  return self;
}
- (IMMsgServRspBuilder*) clearClientHandle {
  resultImmsgServRsp.hasClientHandle = NO;
  resultImmsgServRsp.clientHandle = 0;
  return self;
}
- (BOOL) hasUserName {
  return resultImmsgServRsp.hasUserName;
}
- (NSString*) userName {
  return resultImmsgServRsp.userName;
}
- (IMMsgServRspBuilder*) setUserName:(NSString*) value {
  resultImmsgServRsp.hasUserName = YES;
  resultImmsgServRsp.userName = value;
  return self;
}
- (IMMsgServRspBuilder*) clearUserName {
  resultImmsgServRsp.hasUserName = NO;
  resultImmsgServRsp.userName = @"";
  return self;
}
- (BOOL) hasPassword {
  return resultImmsgServRsp.hasPassword;
}
- (NSString*) password {
  return resultImmsgServRsp.password;
}
- (IMMsgServRspBuilder*) setPassword:(NSString*) value {
  resultImmsgServRsp.hasPassword = YES;
  resultImmsgServRsp.password = value;
  return self;
}
- (IMMsgServRspBuilder*) clearPassword {
  resultImmsgServRsp.hasPassword = NO;
  resultImmsgServRsp.password = @"";
  return self;
}
- (BOOL) hasOnlineStatus {
  return resultImmsgServRsp.hasOnlineStatus;
}
- (UserStatType) onlineStatus {
  return resultImmsgServRsp.onlineStatus;
}
- (IMMsgServRspBuilder*) setOnlineStatus:(UserStatType) value {
  resultImmsgServRsp.hasOnlineStatus = YES;
  resultImmsgServRsp.onlineStatus = value;
  return self;
}
- (IMMsgServRspBuilder*) clearOnlineStatus {
  resultImmsgServRsp.hasOnlineStatus = NO;
  resultImmsgServRsp.onlineStatus = UserStatTypeUserStatusOnline;
  return self;
}
- (BOOL) hasClientType {
  return resultImmsgServRsp.hasClientType;
}
- (ClientType) clientType {
  return resultImmsgServRsp.clientType;
}
- (IMMsgServRspBuilder*) setClientType:(ClientType) value {
  resultImmsgServRsp.hasClientType = YES;
  resultImmsgServRsp.clientType = value;
  return self;
}
- (IMMsgServRspBuilder*) clearClientType {
  resultImmsgServRsp.hasClientType = NO;
  resultImmsgServRsp.clientType = ClientTypeClientTypeWindows;
  return self;
}
- (BOOL) hasClientVersion {
  return resultImmsgServRsp.hasClientVersion;
}
- (NSString*) clientVersion {
  return resultImmsgServRsp.clientVersion;
}
- (IMMsgServRspBuilder*) setClientVersion:(NSString*) value {
  resultImmsgServRsp.hasClientVersion = YES;
  resultImmsgServRsp.clientVersion = value;
  return self;
}
- (IMMsgServRspBuilder*) clearClientVersion {
  resultImmsgServRsp.hasClientVersion = NO;
  resultImmsgServRsp.clientVersion = @"";
  return self;
}
@end
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasClientHandle) {
    [output writeUInt32:6 value:self.clientHandle];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  if (self.hasClientHandle) {
    size_ += computeUInt32Size(6, self.clientHandle);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (BOOL) hasClientHandle {
  return resultImloginReq.hasClientHandle;
}
- (UInt32) clientHandle {
  return resultImloginReq.clientHandle;
}
- (IMLoginReqBuilder*) setClientHandle:(UInt32) value {
  resultImloginReq.hasClientHandle = YES;
  resultImloginReq.clientHandle = value;
  return self;
}
- (IMLoginReqBuilder*) clearClientHandle {
  resultImloginReq.hasClientHandle = NO;
  resultImloginReq.clientHandle = 0;
  return self;
}
@end
...
- (BOOL) hasClientHandle {
  return resultImloginRes.hasClientHandle;
}
- (UInt32) clientHandle {
  return resultImloginRes.clientHandle;
}
- (IMLoginResBuilder*) setClientHandle:(UInt32) value {
  resultImloginRes.hasClientHandle = YES;
  resultImloginRes.clientHandle = value;
  return self;
}
- (IMLoginResBuilder*) clearClientHandle {
  resultImloginRes.hasClientHandle = NO;
  resultImloginRes.clientHandle = 0;
  return self;
}
@end
