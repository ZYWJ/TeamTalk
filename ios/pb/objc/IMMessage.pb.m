...
@property (strong) NSString* toServerName;
@end
...
- (BOOL) hasToServerName {
  return !!hasToServerName_;
}
- (void) setHasToServerName:(BOOL) _value_ {
  hasToServerName_ = !!_value_;
}
@synthesize toServerName;
- (instancetype) init {
  if ((self = [super init])) {
    self.fromUserId = 0;
    self.toSessionId = 0;
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasToServerName) {
    [output writeString:21 value:self.toServerName];
  }
...
- (SInt32) serializedSize {
  ...
  if (self.hasToServerName) {
    size_ += computeStringSize(21, self.toServerName);
  }
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasToServerName) {
    [output appendFormat:@"%@%@: %@\n", indent, @"toServerName", self.toServerName];
  }
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  if (self.hasToServerName) {
    [dictionary setObject: self.toServerName forKey: @"toServerName"];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      self.hasToServerName == otherMessage.hasToServerName &&
      (!self.hasToServerName || [self.toServerName isEqual:otherMessage.toServerName]) &&
...
- (NSUInteger) hash {
  ...
  if (self.hasToServerName) {
    hashCode = hashCode * 31 + [self.toServerName hash];
  }
...
- (IMMsgDataBuilder*) mergeFrom:(IMMsgData*) other {
  ...
  if (other.hasToServerName) {
    [self setToServerName:other.toServerName];
  }
...
- (IMMsgDataBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 170: {
        [self setToServerName:[input readString]];
        break;
      }
    }
  }
...
- (BOOL) hasToServerName {
  return resultImmsgData.hasToServerName;
}
- (NSString*) toServerName {
  return resultImmsgData.toServerName;
}
- (IMMsgDataBuilder*) setToServerName:(NSString*) value {
  resultImmsgData.hasToServerName = YES;
  resultImmsgData.toServerName = value;
  return self;
}
- (IMMsgDataBuilder*) clearToServerName {
  resultImmsgData.hasToServerName = NO;
  resultImmsgData.toServerName = @"";
  return self;
}
@end
...
- (BOOL) hasUserId {
  return resultImclientTimeReq.hasUserId;
}
- (UInt32) userId {
  return resultImclientTimeReq.userId;
}
- (IMClientTimeReqBuilder*) setUserId:(UInt32) value {
  resultImclientTimeReq.hasUserId = YES;
  resultImclientTimeReq.userId = value;
  return self;
}
- (IMClientTimeReqBuilder*) clearUserId {
  resultImclientTimeReq.hasUserId = NO;
  resultImclientTimeReq.userId = 0;
  return self;
}
@end
...
- (BOOL) hasUserId {
  return resultImclientTimeRsp.hasUserId;
}
- (UInt32) userId {
  return resultImclientTimeRsp.userId;
}
- (IMClientTimeRspBuilder*) setUserId:(UInt32) value {
  resultImclientTimeRsp.hasUserId = YES;
  resultImclientTimeRsp.userId = value;
  return self;
}
- (IMClientTimeRspBuilder*) clearUserId {
  resultImclientTimeRsp.hasUserId = NO;
  resultImclientTimeRsp.userId = 0;
  return self;
}
@end
