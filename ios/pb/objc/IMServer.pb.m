...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasClientHandle) {
    [output writeUInt32:3 value:self.clientHandle];
  }
...
- (SInt32) serializedSize {
  ...
  if (self.hasClientHandle) {
    size_ += computeUInt32Size(3, self.clientHandle);
  }
  if (self.hasAttachData) {
...
- (BOOL) hasClientHandle {
  return resultImvalidateReq.hasClientHandle;
}
- (UInt32) clientHandle {
  return resultImvalidateReq.clientHandle;
}
- (IMValidateReqBuilder*) setClientHandle:(UInt32) value {
  resultImvalidateReq.hasClientHandle = YES;
  resultImvalidateReq.clientHandle = value;
  return self;
}
- (IMValidateReqBuilder*) clearClientHandle {
  resultImvalidateReq.hasClientHandle = NO;
  resultImvalidateReq.clientHandle = 0;
  return self;
}
- (BOOL) hasAttachData {
...
- (BOOL) hasClientHandle {
  return resultImvalidateRsp.hasClientHandle;
}
- (UInt32) clientHandle {
  return resultImvalidateRsp.clientHandle;
}
- (IMValidateRspBuilder*) setClientHandle:(UInt32) value {
  resultImvalidateRsp.hasClientHandle = YES;
  resultImvalidateRsp.clientHandle = value;
  return self;
}
- (IMValidateRspBuilder*) clearClientHandle {
  resultImvalidateRsp.hasClientHandle = NO;
  resultImvalidateRsp.clientHandle = 0;
  return self;
}
- (BOOL) hasAttachData {
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasClientHandle) {
    [output writeUInt32:7 value:self.clientHandle];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  if (self.hasClientHandle) {
    size_ += computeUInt32Size(7, self.clientHandle);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (BOOL) hasClientHandle {
  return resultImmsgServInfo.hasClientHandle;
}
- (UInt32) clientHandle {
  return resultImmsgServInfo.clientHandle;
}
- (IMMsgServInfoBuilder*) setClientHandle:(UInt32) value {
  resultImmsgServInfo.hasClientHandle = YES;
  resultImmsgServInfo.clientHandle = value;
  return self;
}
- (IMMsgServInfoBuilder*) clearClientHandle {
  resultImmsgServInfo.hasClientHandle = NO;
  resultImmsgServInfo.clientHandle = 0;
  return self;
}
@end
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasTransMode) {
    [output appendFormat:@"%@%@: %@\n", indent, @"transMode", NSStringFromFileType(self.transMode)];
  }
  if (self.hasAttachData) {
    [output appendFormat:@"%@%@: %@\n", indent, @"attachData", self.attachData];
  }
...
@interface IMConnectionServerName ()
@property (strong) NSString* serverName;
@end

@implementation IMConnectionServerName
...
static IMConnectionServerName* defaultIMConnectionServerNameInstance = nil;
+ (void) initialize {
  if (self == [IMConnectionServerName class]) {
    defaultIMConnectionServerNameInstance = [[IMConnectionServerName alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultIMConnectionServerNameInstance;
}
- (instancetype) defaultInstance {
  return defaultIMConnectionServerNameInstance;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  if (self.hasServerName) {
    [output writeString:1 value:self.serverName];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  size_ = 0;
  if (self.hasServerName) {
    size_ += computeStringSize(1, self.serverName);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
}
+ (IMConnectionServerName*) parseFromData:(NSData*) data {
  return (IMConnectionServerName*)[[[IMConnectionServerName builder] mergeFromData:data] build];
}
+ (IMConnectionServerName*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMConnectionServerName*)[[[IMConnectionServerName builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (IMConnectionServerName*) parseFromInputStream:(NSInputStream*) input {
  return (IMConnectionServerName*)[[[IMConnectionServerName builder] mergeFromInputStream:input] build];
}
+ (IMConnectionServerName*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMConnectionServerName*)[[[IMConnectionServerName builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMConnectionServerName*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (IMConnectionServerName*)[[[IMConnectionServerName builder] mergeFromCodedInputStream:input] build];
}
+ (IMConnectionServerName*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMConnectionServerName*)[[[IMConnectionServerName builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMConnectionServerNameBuilder*) builder {
  return [[IMConnectionServerNameBuilder alloc] init];
}
+ (IMConnectionServerNameBuilder*) builderWithPrototype:(IMConnectionServerName*) prototype {
  return [[IMConnectionServerName builder] mergeFrom:prototype];
}
- (IMConnectionServerNameBuilder*) builder {
  return [IMConnectionServerName builder];
}
- (IMConnectionServerNameBuilder*) toBuilder {
  return [IMConnectionServerName builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasServerName) {
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[IMConnectionServerName class]]) {
    return NO;
  }
  IMConnectionServerName *otherMessage = other;
  return
...
@interface IMConnectionServerNameBuilder()
@property (strong) IMConnectionServerName* resultImconnectionServerName;
@end

@implementation IMConnectionServerNameBuilder
@synthesize resultImconnectionServerName;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultImconnectionServerName = [[IMConnectionServerName alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultImconnectionServerName;
}
- (IMConnectionServerNameBuilder*) clear {
  self.resultImconnectionServerName = [[IMConnectionServerName alloc] init];
  return self;
}
- (IMConnectionServerNameBuilder*) clone {
  return [IMConnectionServerName builderWithPrototype:resultImconnectionServerName];
}
- (IMConnectionServerName*) defaultInstance {
  return [IMConnectionServerName defaultInstance];
}
- (IMConnectionServerName*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (IMConnectionServerName*) buildPartial {
  IMConnectionServerName* returnMe = resultImconnectionServerName;
  self.resultImconnectionServerName = nil;
  return returnMe;
}
- (IMConnectionServerNameBuilder*) mergeFrom:(IMConnectionServerName*) other {
  if (other == [IMConnectionServerName defaultInstance]) {
    return self;
  }
...
- (IMConnectionServerNameBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (IMConnectionServerNameBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
...
- (BOOL) hasServerName {
  return resultImconnectionServerName.hasServerName;
}
- (NSString*) serverName {
  return resultImconnectionServerName.serverName;
}
- (IMConnectionServerNameBuilder*) setServerName:(NSString*) value {
  resultImconnectionServerName.hasServerName = YES;
  resultImconnectionServerName.serverName = value;
  return self;
}
- (IMConnectionServerNameBuilder*) clearServerName {
  resultImconnectionServerName.hasServerName = NO;
  resultImconnectionServerName.serverName = @"";
  return self;
}
@end
